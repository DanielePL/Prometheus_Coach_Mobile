...
data class CommunityPost(
    ...
    @SerialName("total_volume_kg") val totalVolumeKg: String? = null,
    @SerialName("total_sets") val totalSets: String? = null,
    @SerialName("total_reps") val totalReps: String? = null,
    @SerialName("duration_minutes") val durationMinutes: String? = null,
    @SerialName("prs_achieved") val prsAchieved: String? = null,
...
data class FeedPost(
    ...
    val totalVolumeKg: String? = null,
    val totalSets: String? = null,
    val totalReps: String? = null,
    val durationMinutes: String? = null,
    val prsAchieved: String? = null,
    val caption: String? = null,
    // Media
    @SerialName("image_urls") val imageUrls: List<String>? = null,
    @SerialName("video_urls") val videoUrls: List<String>? = null,
